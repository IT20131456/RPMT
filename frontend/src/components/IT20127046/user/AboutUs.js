            ...
            <div className="container">
              <div className="row">
                <div className="col-9">
                  ...
                  <div className="container">
                    <p>All SLIIT undergraduates must do a research project in their 4th year. 
                      ...
                      Once the supervisor accepted the topic, they must find a co-supervisor of the same research interest.
                    </p>
                    <p>After finalizing the supervisor student must send a document including the topic details of the Research. 
                      Then topic evaluation panel will evaluate the topic and send feedback to the student group. 
                      If the topic is accepted, they can continue to do the project. If rejected, they must find a new topic and submit it back.
                    </p>
                    <p>There are several evaluation stages. Document submissions are evaluated by the supervisor or the co-supervisor. 
                      Presentations will be evaluated by a separate panel. The final Thesis will be Double evaluated by the supervisor and a blind reviewer.
                    </p>
                  </div>
                  ...
                  <div className="container">
                    <center>
                      <img src={SquadUnitLogo} style={{width: "220px", height: "180px"}}/>
                    </center>
                  </div>
                  <br />
                  <div className="container">
                  <div className='row'>
                    <div className='col p-3 mb-2 m-2 bg-light text-dark'>
                      <center>
                      <img src={BlankProfile} style={{width: "150px", height: "150px", marginBottom: "5px"}}/>
